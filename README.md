...
## Business Task:
How do casual riders and annual members use Cyclistic bikes differently? The goal is to provide insights into user behavior that will aid the marketing team in how to convert casual riders into annual paid subscribers.

## Project Phases:
- [1] Ask
  - What is the problem we are trying to solve?
    - Increasing revenue by converting casual riders to paid members.
