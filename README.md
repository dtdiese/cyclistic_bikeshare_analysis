...
* \[3] Process
  ...
  * Hundreds of thousands of rows of missing values in the Start and End Station ID and Names were encoded to reflect that they were Electric Bike rides with no proper station.
  * Less than 0.1% of the observations were deleted because they were missing values for the start and end latitude and longitude.
  * Fixed datetime formatting errors in the start and end time columns.
  * Calculated new variables for the start Hour, Day and Month times, and the total length (in minutes) of each ride.
* \[4] Analyze
